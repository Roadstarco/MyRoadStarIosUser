...
//        let url = "https://myroadstar.org/api/user/signup"
        ...
        AF.request(url, method: .post, parameters: logIn, encoder: JSONParameterEncoder.default, headers: headers).validate(statusCode: 200..<300).validate(contentType: ["application/json"]).responseDecodable(of: LogInResponse.self) { (response) in
