...
class CardsRepository {
    ...
    func deleteCardList(card:PaymentCardModel, block: @escaping (Bool, Error?) -> Void) {
        ...
        AF.request(url, method: .post, parameters: params, headers: headers).validate(statusCode: 200..<300).validate(contentType: ["application/json"]).response{ (response) in
