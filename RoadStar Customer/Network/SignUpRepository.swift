...
class SignUpRepository {
    ...
    func signUp(with signUp: SignUp, block: @escaping (SignUpResponse?, Error?) -> Void) {
        ...
        AF.request(url, method: .post, parameters: signUp, encoder: JSONParameterEncoder.default, headers: headers).validate(statusCode: 200..<300).validate(contentType: ["application/json"]).responseDecodable(of: SignUpResponse.self) { (response) in
